...
LAB0:    t6 = ((STD_TEXTIO) + 3400);
    ...
    *((char **)t7) = t8;
    t9 = xsi_get_transient_memory(8192U);
    memset(t9, 0, 8192U);
    t10 = t9;
    t11 = (32U * 1U);
    t12 = t10;
...
LAB11:    t0 = xsi_get_transient_memory(8192U);
    memcpy(t0, t7, 8192U);
...
LAB8:;
LAB10:    xsi_size_not_matching(8192U, 8192U, 0);
    goto LAB11;
...
extern void work_p_2188849903_init()
{
	...
	xsi_register_didat("work_p_2188849903", "isim/test_processeur_isim_beh.exe.sim/work/p_2188849903.didat");
